...
ANNOTATION_FILE_PATH = "../../ChIPseq/CSV_feature_files_mm10/"  # path to load genomic coordinates of features and regions from functional annotation literature
DATA_FILE_PATH = "../../ChIPseq/Programs/analysis_f200_r5_q10/" # path to load analysis data and write output
BAM_FILE_PATH="../../ChIPseq/BAMfiles/"                         # path to BAM files with ChIPseq read alignments
